...
Route::post('/brands/action', 'BrandController@insertBrand');

Route::get('/brands/list', 'BrandController@list');

Route::get('/brands/update/{id}', 'BrandController@update');

Route::post('/brands/update/action','BrandController@updateBrand');
